...
# Write new configuration file with modified timeout settings
...
AuthIdleTimeout 5       # Idle timeout in seconds (forces re-authentication)
ClientForceTimeout 5    # Force re-authentication after 5 seconds
ClientIdleTimeout 5     # Timeout for idle clients (forces them to re-authenticate)
CheckInterval 10        # Check interval for idle clients
